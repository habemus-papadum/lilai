...
class Bottleneck(nn.Module):
    ...
    def __init__(
        ...
        super().__init__()
        # TODO(human): Implement the Bottleneck __init__
        #
        # You need to create:
        ...
        #
        # Note: The stride is applied in conv2 (the 3x3), not conv1!
        pass
...
class ResNet(nn.Module):
    ...
    def _make_layer(
        ...
        """
        # TODO(human): Implement _make_layer
        #
        ...
        #    - First block: block(self.in_channels, planes, stride, downsample)
        #    - Update self.in_channels = planes * block.expansion
        #    - Remaining blocks: block(self.in_channels, planes) with stride=1, no downsample
        #
